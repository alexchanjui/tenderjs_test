...
CREATE TABLE [dbo].[_prisma_new_permission] (
    ...
    [sortOrder] INT NOT NULL CONSTRAINT [permission_sortOrder_df] DEFAULT 0,
...
SET IDENTITY_INSERT [dbo].[_prisma_new_permission] ON;
...
SET IDENTITY_INSERT [dbo].[_prisma_new_permission] OFF;
